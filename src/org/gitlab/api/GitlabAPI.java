...
public class GitlabAPI {
    ...
    public List<GitlabIssue> getIssues(GitlabProject project,GitlabIssueState state) throws IOException {
        String tailUrl = GitlabProject.URL + "/" + project.getId() + GitlabIssue.URL+(state!=null?"?state="+state.getType():"");
